...
export default function Dashboard(){
 ...
 async function sendOnway(o:Order){
  ...
  if(o.tracking_code&&!confirm(`შეკვეთას #${o.order_number} უკვე აქვს თრექინგ კოდი: ${o.tracking_code}\n\nმაინც გავაგზავნოთ OnWay-ში?`))return;
